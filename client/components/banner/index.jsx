...
class Banner extends Component {
	...
	render() {
		...
		const classes = classNames(
			...
			{ 'is-upgrade-personal': includes( [ PLAN_PERSONAL, PLAN_JETPACK_PERSONAL, PLAN_JETPACK_PERSONAL_MONTHLY ], plan ) },
			{ 'is-upgrade-premium': includes( [ PLAN_PREMIUM, PLAN_JETPACK_PREMIUM, PLAN_JETPACK_PREMIUM_MONTHLY ], plan ) },
			{ 'is-upgrade-business': includes( [ PLAN_BUSINESS, PLAN_JETPACK_BUSINESS, PLAN_JETPACK_BUSINESS_MONTHLY ], plan ) },
